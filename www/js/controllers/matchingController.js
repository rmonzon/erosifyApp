...
angular.module('controllers').controller('MatchingController', function ($scope, GenericController) {
    ...
    function init() {
        ...
        $scope.messages = [
            ...
            { user: 'Amanda', id: 7, lastMsg: "Shall we go dinner tonight?", unreadMsg: true, verified: true, fav: true, date: "14/02/2016", online: false },
            ...
            { user: 'Diana', id: 10, lastMsg: "Hi there!", unreadMsg: true, verified: true, fav: false, date: "Yesterday", online: false },
            { user: 'Samantha', id: 11, lastMsg: "Hi there!", unreadMsg: true, verified: false, fav: true, date: "12/23/2015", online: true },
